...
def find_employee_by_id():
    ...
    print(employee) if employee else print(f'Employmee {id_} not found')
...
def update_employee():
    id_ = input("Enter the empolyee's id: ")
...
def list_department_employees():
    ...
    print(employees) if employees else print(f'Department employees not found')
